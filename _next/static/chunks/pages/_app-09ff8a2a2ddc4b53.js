    ...
    [888], {
        9548: function(t, e, r) {
            ...
            function s() {
                return (s = (0, u.default)(o.default.mark(function t(e, r, n) {
                    var a, u, i, s, f, p, d, v, h, y = arguments;
                    ...
                    return r[n] = (0, a.default)(o.default.mark(function r() {
                        ...
                        return o.default.wrap(function(r) {
                            for (;;) switch (r.prev = r.next) {
                                ...
                                case 9:
                                    throw r.prev = 9, r.t0 = r.catch(0), e.error("adapter_error_".concat(n), r.t0), (s = new v(r.t0)).name = "".concat(j(n), "Error"), s;
                                case 15:
                                case "end":
                                    return r.stop()
                            }
        ...
        3299: function(t, e, r) {
            ...
            e.SessionContext = void 0, e.SessionProvider = function(t) {
                ...
                y.useEffect(function() {
                    return S._getSession = (0, v.default)(p.default.mark(function t() {
                            var e, r, n = arguments;
                ...
                var T = (e = y.useState("undefined" != typeof navigator && navigator.onLine), n = (r = (0, h.default)(e, 2))[0], o = r[1], a = function() {
                        return o(!0)
                    }, u = function() {
                        return o(!1)
                    }, y.useEffect(function() {
                ...
                var U = y.useMemo(function() {
                    return {
                        ...
                        update: function(t) {
                            return (0, v.default)(p.default.mark(function e() {
                                var r;
                                return p.default.wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 2:
                                            return j(!0), e.t0 = b.fetchData, e.t1 = S, e.t2 = k, e.next = 8, M();
                                        case 8:
                                        ...
                                        case 15:
                                            return r = e.sent, j(!1), r && (m(r), P.post({
                                                event: "session",
                                                data: {
                                                    trigger: "getSession"
                                                }
            ...
            function T() {
                return (T = (0, v.default)(p.default.mark(function t(e) {
                    var r, n;
                    return p.default.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
            ...
            function A() {
                return (A = (0, v.default)(p.default.mark(function t(e) {
                    var r;
                    return p.default.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
            ...
            function C() {
                return (C = (0, v.default)(p.default.mark(function t() {
                    return p.default.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
            ...
            function N() {
                return (N = (0, v.default)(p.default.mark(function t(e, r, n) {
                    var o, a, u, i, c, s, l, f, d, v, h, y, g, x, w, m, _;
                    return p.default.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                            ...
                            case 11:
                                return f = "credentials" === l[e].type, d = "email" === l[e].type, v = f || d, h = "".concat(s, "/").concat(f ? "callback" : "signin", "/").concat(e), y = "".concat(h, "?").concat(new URLSearchParams(n)), t.t0 = fetch, t.t1 = y, t.t2 = {
                                    "Content-Type": "application/x-www-form-urlencoded"
                                }, t.t3 = URLSearchParams, t.t4 = j, t.t5 = j({}, r), t.t6 = {}, t.next = 25, M();
                            case 25:
            ...
            function I() {
                return (I = (0, v.default)(p.default.mark(function t(e) {
        ...
        8484: function(t, e, r) {
            ...
            function s(t) {
                ...
                return (0, n.jsx)(c.i, {
                    children: (0, n.jsx)(o.SessionProvider, {
                        session: r,
                        children: (0, n.jsxs)(a.w, {
                            children: [(0, n.jsxs)(i(), {
        ...
        7656: function(t, e, r) {
            ...
            function u(t) {
                let {
                    children: e
                } = t, [r, u] = (0, o.useState)("pt");
                (0, o.useEffect)(() => {
                    let t = localStorage.getItem("selectedLanguage");
                    t && u(t)
                }, []);
                let i = t => {
                    u(t), localStorage.setItem("selectedLanguage", t)
                };
                return (0, n.jsx)(a.Provider, {
                    value: {
                        currentLanguage: r,
                            ...
                            for (o.method = e, o.arg = n;;) {
                                ...
                                if (u) {
                                    var i = function t(e, r) {
                                        var n = r.method,
                                            o = e.iterator[n];
                                        if (void 0 === o) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = void 0, t(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = TypeError("The iterator does not provide a '" + n + "' method")), h;
                                        var a = v(o, e.iterator, r.arg);
                                        if ("throw" === a.type) return r.method = "throw", r.arg = a.arg, r.delegate = null, h;
                                        var u = a.arg;
                                        return u ? u.done ? (r[e.resultName] = u.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = void 0), r.delegate = null, h) : u : (r.method = "throw", r.arg = TypeError("iterator result is not an object"), r.delegate = null, h)
                                    }(u, o);
                                    if (i) {
                                        if (i === h) continue;
                                        return i
                                ...
                                var c = v(t, r, o);
                                if ("normal" === c.type) {
                                    if (a = o.done ? "completed" : "suspendedYield", c.arg === h) continue;
                                    return {
                                        value: c.arg,
                                        done: o.done
                                    }
